...
describe('SettingLookAndFeel', () => {
  ...
  it('renders the Interface & Behavior toggles', () => {
    ...
    expect(screen.getByText('Full Translucency')).toBeInTheDocument()
  ...
  it('toggles Mirror Mode in the store', () => {
    render(<SettingLookAndFeel />)
    const checkbox = switchInputFor('Mirror Mode')
    expect(checkbox.checked).toBe(true)
    fireEvent.click(checkbox)
    expect(useSettingsStore.getState().settings.mirrorMode).toBe(false)
  })

  it('toggles Full Translucency in the store', () => {
    render(<SettingLookAndFeel />)
    const checkbox = switchInputFor('Full Translucency')
    expect(checkbox.checked).toBe(false)
    fireEvent.click(checkbox)
    expect(useSettingsStore.getState().settings.translucency).toBe(true)
  })
