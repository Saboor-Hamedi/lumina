...
const PreviewModal = ({ isOpen, onClose, content }) => {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container preview-container" style={{ width: '90vw', height: '85vh' }} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="preview-body" ref={onHostRef} style={{ flex: 1, overflow: 'auto', background: 'var(--bg-app)' }}>
