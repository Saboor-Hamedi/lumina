/**
 * =========================================================================================
 * Image Lightbox Module (`imageLightbox.js`)
 * =========================================================================================
 * 
 ...
 */
function createImageToolbar({ onZoomIn, onZoomOut, onReset, onCopy, getScaleText }) {
 ...
 * 
 * @param {HTMLImageElement|string} imgSource Image element or source URL
 */
export function openImageLightbox(imgSource) {
