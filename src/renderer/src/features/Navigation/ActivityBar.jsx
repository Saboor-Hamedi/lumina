...
import { Network, Calendar, Palette, Settings, ArrowUpCircle, RefreshCw, Files, MessageSquare } from 'lucide-react'
 ...
 */
const ActivityBar = ({ onSettingsClick, onThemeClick, onToggleGraph, onToggleExplorerModal, onToggleAIChat }) => {
