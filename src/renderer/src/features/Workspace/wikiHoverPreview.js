 ...
 */
export const wikiHoverPreview = (getSnippets, onCreate) => hoverTooltip((view, pos, side) => {
  // 1. Get line
      ...
      return {
        ...
        create(editorView) {
          try {
            ...
            const snippet = snippets.find(s => s.title.toLowerCase() === targetTitle.toLowerCase())
